            ...
            <div class="page">
                ...
                <div class="grid">
                    <?php if (!empty($dbError)): ?>
                        <div class="empty">Database error: <?= $dbError ?>. Import <a href="../database/parliament_cafeteria.sql">database/parliament_cafeteria.sql</a> and try again.</div>
                    <?php elseif (!$menu): ?>
